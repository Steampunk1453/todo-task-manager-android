...
internal class UpdateAudiovisualTest {

    @MockK
    private lateinit var repository: AudiovisualRepository

    @InjectMockKs
    private lateinit var useCase: UpdateAudiovisual

    @Test
    fun `should return audiovisual when execute update`() = runBlockingTest  {
        // Given
        val audiovisual = AudiovisualStub.random()
        coEvery { repository.update(any()) } returns Result.Success(audiovisual)
        // When
    ...
    @Test
    fun `should return null audiovisual when execute update`() = runBlockingTest  {
        // Given
        val audiovisual = AudiovisualStub.random()
